...
enum Queries {
    ...
    INSERT_PLAYER_MAP("INSERT INTO %s_player_maps (`player_uuid`, `map_uuid`, `owner`, `visibility`) VALUES (:player_uuid, :map_uuid, :owner, :visibility)"),
    ...
    SELECT_PLAYER_MAP("SELECT * FROM %s_player_maps WHERE `player_uuid` = :player_uuid AND `map_uuid` = :map_uuid"),
